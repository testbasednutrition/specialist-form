...
const expertsToAdd = [
  {
    ...
    primary_testing_methods: ["Finger Prick Balance Testing (Omega 6:3)"]
  },
  {
    first_name: "Mariusz",
    last_name: "Domasat",
    ...
    email_address: "contact@test-basednutrition.com",
  ...
  },
  {
    ...
    consultation_type: "Both",
    accepting_new_clients: true,
    primary_testing_methods: ["Finger Prick Balance Testing (Omega 6:3)", "HbA1c - Diabetes (FP)"]
  },
  {
    first_name: "Fiona",
    last_name: "Pursglove",
    ...
    consultation_type: "Both",
    accepting_new_clients: true,
    primary_testing_methods: ["Finger Prick Balance Testing (Omega 6:3)", "Finger Prick Gut Health Testing"]
  },
  {
    first_name: "Emily",
    last_name: "Holland",
    ...
    consultation_type: "Both",
    accepting_new_clients: true,
    primary_testing_methods: ["Finger Prick Gut Health Testing"]
  },
  {
    first_name: "Kia",
    last_name: "Porter",
